...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpa
-functions" xmlns:html="http://www.w3.org/1999/xhtml" xmlns="http://www.w3.org/1999/xhtml" exclude-result-prefixes="html">
	...
	<xsl:template match="/">
		<html>
			<head>
				<style type="text/css">
					<xsl:text>
					*, body, html { font-family:Helvetica;font-size:10pt; }
					table { width:100%; }
