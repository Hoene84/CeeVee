...
<xsl:output method="xml" version="1.0" encoding="ISO-8859-1" indent="yes"/>
	...
	<xsl:attribute-set name="evenRowAttrs">
		<xsl:attribute name="background-color">#FFFFDD</xsl:attribute>
	</xsl:attribute-set>
	...
	<xsl:template match="/">
		<root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			<layout-master-set>
				<simple-page-master page-height="297mm" page-width="210mm" margin="5mm 25mm 5mm 25mm" master-name="PageMaster">
					<region-body margin="20mm 0mm 20mm 0mm"/>
				</simple-page-master>
			</layout-master-set>
